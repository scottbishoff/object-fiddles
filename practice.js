...
// Create a function called MakeCard which takes in all the data it needs to make a Credit Card object and returns that object so that whenever you invoke MakeCard, you get a brand new credit card.
  ...
  function MakeCard(cardNum, cardDate, cardCvc, cardName) {
    return {
      cardNum: cardNum,
      cardDate: cardDate,
      cardCvc: cardCvc,
...
function bindCard(MakePerson, creditCard) {
  var newObj = {};
  for (var obj1 in MakePerson) {newObj[obj1] = MakePerson[obj1]}
  for (var obj2 in creditCard) {newObj[obj2] = creditCard[obj2]}
    return newObj;
}
